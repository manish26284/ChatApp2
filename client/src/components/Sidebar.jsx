...
const Sidebar = () => {
  ...
  // user will we are searching in search bar
       ...
       <div className='pb-5'>
          ...
          <div className='flex justify-between items-center'>
             ...
             <div className='relative py-2 group'>
                ...
                <div className='absolute top-full right-0 z-20 w-32
                p-5 rounded-md bg-[#282142] border border-gray-600 
                text-gray-100 hidden group-hover:block'>
                  ...
                  <hr 
                  className='my-2 border-t border-gray-500' />
          ...
          flex items-center gap-2 py-2 px-4 mt-5'>
             <img 
             src={assets.search_icon} 
             alt="Search" className='w-3' />
