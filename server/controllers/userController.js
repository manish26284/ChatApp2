...
export const login = async (req, res) =>{
   try {
      ...
      // Now it will compare pass and password store in our mongodB 
    ...
    try {
      ...
      if(!profilePic){
        updatedUser =  await User.findByIdAndUpdate(userId, {bio, fullName}, 
         ...
         // Now I have to change profile pic Now we change to update the cloudinary storage
         const upload = await cloudinary.uploader.upload(profilePic);
         
         // param : userid, data to be updated
